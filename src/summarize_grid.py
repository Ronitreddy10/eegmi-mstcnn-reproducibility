        ...
        summary_rows.append(
            {
                ...
                "seed": a["seed"],
                "kernels": "+".join(map(str, data.get("kernels", a.get("kernels", [])))),
                "tmin_seconds": data.get("epoch", {}).get("tmin_seconds", a.get("tmin")),
                "tmax_seconds": data.get("epoch", {}).get("tmax_seconds", a.get("tmax")),
